...
INDEX idx_name (name) ) ENGINE=InnoDB;
...
-- Index
INDEX idx_user_lists (user_id) ) ENGINE=InnoDB;
...
-- Index
INDEX idx_book_rating (book_id, rating) ) ENGINE=InnoDB;
...
-- Index
INDEX idx_goal_date (goal_id, milestone_date) ) ENGINE=InnoDB;
...
-- Index
INDEX idx_period (period) ) ENGINE=InnoDB;
...
-- Index
INDEX idx_date_added (date_added) ) ENGINE=InnoDB;
